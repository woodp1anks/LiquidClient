...
import woodp1anks.liquidclient.gui.MainMenuGui;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(LiquidClient.NAME + " | " + LiquidClient.VERSION + " | Loading...");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    LiquidClient.modManager.getEnabledMods().forEach(mod -> mod.onKeyPressed(k));

                    LiquidClient.modManager.onKeyPressed(k);
