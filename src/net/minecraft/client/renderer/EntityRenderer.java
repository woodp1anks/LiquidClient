...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        LiquidClient.modManager.getEnabledMods().forEach(Mod::render);
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        for (Mod mod : LiquidClient.modManager.getEnabledMods()) {
            if (mod.getName().equals("AntiBlind")) {
                antiBlind = (AntiBlind) mod;
            }
        }

        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness) && !antiBlind.isBlindDisabled())
        {
